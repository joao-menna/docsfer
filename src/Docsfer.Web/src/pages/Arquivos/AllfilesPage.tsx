      ...
      <>
        ...
        <div className="flex flex-col w-full">
          <div className="flex flex-col gap-2 px-6 py-4 w-full">
            <h2 className="font-josefin text-xl dark:text-zinc-200">
              Arquivos
            </h2>
            {/* Filters */}
            <div className="flex justify-between md:max-w-2xl lg:max-w-5xl w-full">
              ...
              <button
                onClick={toggleView}
                className={clsx("inline-flex rounded-md group")}
              >
               <div className={clsx("px-4 py-2 h-10 text-gray-500 flex-center gap-2 rounded-s-lg border border-gray-500", viewMode === 'grid' ? "bg-gray-500 text-gray-200!" : "")}>
                 <Table />
                 Grid
               </div>
                <div className={clsx("px-4 py-2 h-10 text-gray-500 flex-center gap-2 rounded-e-lg border border-gray-500", viewMode === 'list' ? "bg-gray-600 text-gray-200!" : "")}>
                  <List />
                  List
                </div>
              </button>
