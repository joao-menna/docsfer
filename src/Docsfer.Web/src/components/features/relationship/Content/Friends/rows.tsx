...
export function FriendsRow() {
  return (
    <div className="flex w-full h-16 justify-between items-center mx-2 my-3 xl:max-w-4xl lg:max-w-2xl border-y group hover:bg-[#1a2133] border-gray-800 transition-all duration-200 ease-out friendRowHover hover:border-0">
